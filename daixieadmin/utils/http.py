...
def get_arg(key, default, example=None):
    converter = default if example == None else example
    try:
        return converter.__class__(request.args.get(key, default))
    except:
        return default

if __name__ == '__main__':
    default = 1
    print default.__class__('2')
